package com.vinaysteja.vinayschool.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.vinaysteja.vinayschool..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.vinaysteja.vinayschool.*.*(..))",throwing = "ex")
